(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('lodash/isPlainObject'), require('lodash/filter'), require('lodash/omit'), require('@nivo/core'), require('@react-spring/web')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'lodash/isPlainObject', 'lodash/filter', 'lodash/omit', '@nivo/core', '@react-spring/web'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.PropTypes, global['lodash/isPlainObject'], global['lodash/filter'], global['lodash/omit'], global.nivo, global['@react-spring/web']));
}(this, (function (exports, React, PropTypes, isPlainObject, filter, omit, core, web) { 'use strict';
    ...
    var AnnotationNote = React.memo(function (_ref) {
      ...
      return React__default.createElement(React__default.Fragment, null, theme.annotations.text.outlineWidth > 0 && React__default.createElement(web.animated.text, {
        x: animatedProps.x,
        y: animatedProps.y,
      ...
      }, note), React__default.createElement(web.animated.text, {
        x: animatedProps.x,
        y: animatedProps.y,
    ...
    var CircleAnnotationOutline = React.memo(function (_ref) {
      ...
      return React__default.createElement(React__default.Fragment, null, theme.annotations.outline.outlineWidth > 0 && React__default.createElement(web.animated.circle, {
        cx: animatedProps.x,
        cy: animatedProps.y,
    ...
    var RectAnnotationOutline = React.memo(function (_ref) {
      ...
      return React__default.createElement(React__default.Fragment, null, theme.annotations.outline.outlineWidth > 0 && React__default.createElement(web.animated.rect, {
        x: animatedProps.x,
        y: animatedProps.y,

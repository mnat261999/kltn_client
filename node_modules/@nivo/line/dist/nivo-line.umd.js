(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/colors'), require('@nivo/axes'), require('@nivo/legends'), require('@nivo/tooltip'), require('d3-shape'), require('@nivo/scales'), require('prop-types'), require('@react-spring/web'), require('@nivo/voronoi')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/colors', '@nivo/axes', '@nivo/legends', '@nivo/tooltip', 'd3-shape', '@nivo/scales', 'prop-types', '@react-spring/web', '@nivo/voronoi'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global.nivo, global.nivo, global.d3, global.nivo, global.PropTypes, global['@react-spring/web'], global.nivo));
}(this, (function (exports, React, core, colors, axes, legends, tooltip, d3Shape, scales, PropTypes, web, voronoi) { 'use strict';

(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/tooltip'), require('prop-types'), require('lodash/merge'), require('lodash/get'), require('lodash/set'), require('d3-interpolate'), require('@react-spring/web'), require('lodash/isString'), require('lodash/last'), require('lodash/isArray'), require('d3-scale'), require('d3-scale-chromatic'), require('lodash/isFunction'), require('lodash/without'), require('d3-shape'), require('d3-hierarchy'), require('d3-format'), require('d3-time-format'), require('@nivo/recompose'), require('lodash/isEqual'), require('lodash/isPlainObject'), require('lodash/pick')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/tooltip', 'prop-types', 'lodash/merge', 'lodash/get', 'lodash/set', 'd3-interpolate', '@react-spring/web', 'lodash/isString', 'lodash/last', 'lodash/isArray', 'd3-scale', 'd3-scale-chromatic', 'lodash/isFunction', 'lodash/without', 'd3-shape', 'd3-hierarchy', 'd3-format', 'd3-time-format', '@nivo/recompose', 'lodash/isEqual', 'lodash/isPlainObject', 'lodash/pick'], factory) :
...
}(this, (function (exports, React, tooltip, PropTypes, merge, get, set, d3Interpolate, web, _isString, last, isArray, d3Scale, d3ScaleChromatic, isFunction, without, d3Shape, d3Hierarchy, d3Format, d3TimeFormat, recompose, isEqual, isPlainObject, pick) { 'use strict';

...
class GroupMess extends Component {
  ...
  render() {
    return this.props.mess ? (
      this.props.mess.type == "event" ? (
        <h6 className="chat_event">{this.props.mess.content}</h6>
      ) : this.props.mess.sentBy ? (
        this.props.mess.sentBy._id == this.props.yourProfile._id ? (
              ...
              <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6  sent_mess">
                {this.props.mess.type == "text" ? (
                  <div className="message_content">
                    {this.state.show ? (
                      <h6>
                        {moment(this.props.mess.updatedAt).format("HH:MM A")}
                      </h6>
                    ) : (
                      ""
                    )}
                  ...
                  <img
                    onClick={this.handleMessClick}
                    src={this.props.mess.content}
                  ></img>
                ) : this.props.mess.type == "sticker" ? (
                  <img
                    onClick={this.handleMessClick}
                    className="sticker_mess"
                    src={this.props.mess.content}
                  ></img>

                ...
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto navbar-list">
                            <li>
                                <Link to='' class="iq-waves-effect d-flex align-items-center">
                                    <img src={Object.keys(auth.user.avatar).length > 0 ? auth.user.avatar.url : "https://social-pet-bucket.s3.amazonaws.com/avatar_default.png"} class="img-fluid rounded-circle mr-3" alt="user" />
                                    <div class="caption">
                                        <h6 class="mb-0 line-height">{auth.user.fullname}</h6>
                                    </div>
                                </Link>
                            </li>
                            <li>
                                <Link onClick={home} class="iq-waves-effect d-flex align-items-center">
                        ...
                        <ul class="navbar-list">
                            <li>
                                <Link to = '' class="search-toggle iq-waves-effect d-flex align-items-center">
                                    ...
                                    <div class="iq-card shadow-none m-0">
                                        <div class="iq-card-body p-0 ">
                                            ...
                                            <div class="d-inline-block w-100 text-center p-3">
                                                <Link onClick={handleLogout} class="bg-primary iq-sign-btn" href="sign-in.html" role="button">Sign out<i class="ri-login-box-line ml-2"></i></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
